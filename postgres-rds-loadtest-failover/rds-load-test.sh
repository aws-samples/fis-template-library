...
# PostgreSQL RDS Load Test Script
# This script simulates load on a PostgreSQL RDS instance by:
# 1. Creating a test table if it doesn't exist
# 2. Running concurrent INSERT operations
# 3. Running concurrent SELECT queries with different complexity
